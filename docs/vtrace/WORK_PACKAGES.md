...
| WP-002 | Prove RALLY compatibility. | Neutral RALLY evidence maps without moving mechanics. | REQ-008; SPEC-006; IF-003 | RALLY adapter/fixtures, SCENARIUM tests | WP-001 L1 complete. | Accepted and failure fixtures pass; migration/deletion plan reviewed. | L0 yes / L1 yes / L2 yes | ready |
| WP-003 | Prove SIGNALS artifact interchange. | One sidecar maps losslessly with provenance. | REQ-006/009; SPEC-004/007; IF-004 | SIGNALS fixture/adapter, SCENARIUM tests | WP-001 L1 complete. | Known fields round-trip; unknowns observable; no methodology dependency. | L0 yes / L1 yes / L2 yes | ready |
