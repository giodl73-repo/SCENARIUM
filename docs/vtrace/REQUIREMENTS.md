...
| REQ-011 | The crate shall document MSRV, dependency policy, feature policy, semantic-versioning rules, and the no-registry-publication policy before release readiness. | Ecosystem release | Adoption requires predictable maintenance without registry publication. | must | Rust Ecosystem Maintainer | package inspection | accepted |
